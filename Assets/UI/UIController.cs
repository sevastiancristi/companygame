...
public class UIController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        goArray.Add(BuildRoundButtonsMenu(go, 2, 3));
        ...
        GameObject go3 = BuildSquareButtonsMenu(goArray[0], 0);
        ...
        goArray[0].transform.GetComponent<AbstractButtonsMenuController>().removeButtonAtIndex(3);
        go3.transform.GetComponent<AbstractButtonsMenuController>().removeButtonAtIndex(5);
    }
    ...
    public void arrangeRoundButtonsMenuRelativeToParent(GameObject go, GameObject parent, int parentButtonIndex, int buttonsCount)
    {
        ...
        {
            startIndex = parentButtonIndex - (buttonsCount + 1) / 2;
            endIndex = startIndex + buttonsCount;
        ...
        {
            startIndex = parentButtonIndex - buttonsCount / 2;
            endIndex = startIndex + buttonsCount;
            while (startIndex < 0)
            {
                startIndex++;
    ...
    public GameObject BuildRoundButtonsMenu(GameObject parent, int parentButtonIndex, int buttonsCount)
    {
        if (parent.transform.GetComponent<RoundButtonsMainMenuController>() != null)
        {
            ...
            arrangeRoundButtonsMenuRelativeToParent(go, parent, parentButtonIndex, buttonsCount);
