...
public class SquareButtonController : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler
{
    ...
    private void adjustFaceBorderSize()
    {
        InitTransformMembers();
       // functionTransform.GetComponent<RectTransform>().anchoredPosition = new Vector3(0f, _faceBorderSize, 0f);
